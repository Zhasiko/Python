...
class Wall(pygame.sprite.Sprite):
    ...
    def draw_wall(self):
        image_wall = pygame.image.load('C:\pythonn\TSIS9\wall.png')
...
image = pygame.image.load('C:\pythonn\TSIS9\grusha.png')
...
music = pygame.mixer.Sound("C:\pythonn\TSIS9\sound.mp3")    #фоновая музыка
music.play(-1)
...
def choosing():
    menu_background = pygame.image.load("C:\pythonn\TSIS9\menu.png")
